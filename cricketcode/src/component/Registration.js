  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <Form onSubmit={handleRegister} style={{ textAlign: "center" }} ref={form}>
          {!successful &&
            (<div>
              ...
              />
              <button type="submit" className="btn btn-primary mb-2 pb-3" id="submitButton" >Register Account</button>
        ...
        <p className="form-message" id="signupLink">Already a User? <Link to="/">Login</Link></p>      </div>
    </>
  );
};
